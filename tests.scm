...
'(10 (40 70) (3 (45 70 (3))))
; expect (10 (40 70) (3 (45 70 (3))))

'(5 (50 7 (21)) . 8)
; expect (5 (50 7 (21)) . 8)

'(a b c 'd e)
; expect (a b c (quote d) e)

'(it was . (a . (rainy day)))
; expect (it was a rainy day)
...
(define age-in-2000 (- age 14))
; expect age-in-2000

age-in-2000
; expect 6

(+ (- age 10) age-in-2000 10)
; expect 26
...
(lambda (w y z) (* w y z))
; expect (lambda (w y z) (* w y z))

(lambda (x) (+ x 2) (display x) (* x 2))
; expect (lambda (x) (begin (+ x 2) (display x) (* x 2)))
...
(define combine (mu (x) (+ x y)))
; expect combine

(define square (lambda (x y) (combine (* x x))))
; expect square
